...
public:
	...
	*/
	...
	virtual bool OnRedstoneToBlockAt        (cWorld & a_World, int a_BlockX, int a_BlockY, int a_BlockZ, BLOCKTYPE a_BlockType, NIBBLETYPE a_BlockMeta, cRedstoneHandler::PoweringData PowerData) override;
